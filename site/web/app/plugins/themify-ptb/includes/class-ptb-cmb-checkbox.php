			...
			<fieldset class="ptb_cmb_input">
				<ul id="<?php print( $id ); ?>_options_wrapper" class="ptb_cmb_options_wrapper">
					<li class="<?php print( $id ); ?>_option_wrapper ptb_cmb_option">
						...
						<input type="checkbox" name="<?php print( $id ); ?>_default_checked"
						       class="ptb_cmb_option_default_checked"><span
							class="<?php print( $id ); ?>_default_checked_label ptb_cmb_option_default_checked_label"><?php _e( 'Pre-check this','ptb') ?></span>
	...
	public function action_them_themplate( $id, $type, $args, $data = array(), array $languages = array() ) {
		...
		<div class="<?php echo $pluginame ?>_back_active_module_row">
			<div class="<?php echo $pluginame ?>_back_active_module_label">
                            <label for="<?php echo $pluginame ?>_<?php echo $id ?>[display_one_line]"><?php  _e( 'Display multiple checkboxes as', 'ptb' ) ?></label>
                        </div>
		...
		<fieldset>
			...
			foreach ( $args['options'] as $option ) {
				...
				<label for="<?php print( $id ); ?>">
					<input type="checkbox" id="<?php print( $id ); ?>"
					       name="<?php print( $name ); ?>"
					       value="<?php print( $id ); ?>" 
			...
			?>
                    <input type="hidden" value="" name="<?php print( $name ); ?>" />
		</fieldset>
	<?php
