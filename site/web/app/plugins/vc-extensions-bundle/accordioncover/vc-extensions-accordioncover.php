...
if (!class_exists('VC_Extensions_AccordionCover')) {
    class VC_Extensions_AccordionCover{
        function VC_Extensions_AccordionCover() {
            vc_map(array(
            ...
            "params" => array(
              ...
              array(
                ...
                "group" => "Image",
                "description" => __("Default we will use the original image, specify a width. For example, 200 will resize the image to width 200. Please use it carefully, may not work with some server setup.", "vc_accordioncover_cq")
              ),
              array(
                "type" => "exploded_textarea",
                "holder" => "",
...
[captionitem]item caption 3[/captionitem]'
          ...
          foreach ($imagesArr as $key => $theimage) {
              ...
              if($imageLocation[0]!=""){
                  if($isresize=="yes"&&$imagewidth!=""){
                    $image_str .= '<div class="cq-accordioncover-item cq'.count($imagesArr).'" data-image="'.aq_resize($imageLocation[0], $imagewidth, null, true, true, true).'">';
                      ...
                      $image_str .= '<div class="cq-accordioncover-item cq'.count($imagesArr).'" data-image="'.$imageLocation[0].'">';
                      $image_str .= '<div class="cq-accordioncover-background"></div>';
                      $image_str .= '<div class="cq-accordioncover-overlay">';
                      $image_str .= '<div class="cq-accordioncover-textcontainer">';
                      if(isset($titles[$i])&&$titles[$i]!=""){
        ...
        add_shortcode('cq_vc_accordioncover', 'cq_vc_accordioncover_func');
