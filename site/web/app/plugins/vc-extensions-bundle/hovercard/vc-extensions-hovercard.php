...
if (!class_exists('VC_Extensions_HoverCard')) {
    class VC_Extensions_HoverCard{
        function VC_Extensions_HoverCard() {
            vc_map(array(
            ...
            "params" => array(
              ...
              array(
                ...
                "group" => "Background",
                "description" => __("Default we will use the original image, specify a width. For example, 200 will resize the image to width 200. Please use it carefully, may not work with some server setup.", "vc_hovercard_cq")
              ),
              array(
                "type" => "colorpicker",
                "holder" => "div",
        ...
        function cq_vc_hovercard_func($atts, $content=null, $tag) {
          $captionicon = $icon_fontawesome = $icon_openiconic = $icon_typicons = $icon_entypo = $icon_linecons = '';
          ...
          if($linktype=="lightbox"){
              $output .= '<a href="'.$image[0].'" class="cq-hovercard-lightbox">';
          ...
          if($image[0]!=""){
              if($isresize=="yes"&&$imagewidth!=""){
                  $output .= '<img src="'.aq_resize($image[0], $imagewidth, null, true, true, true).'" />';
              }else{
                  $output .= '<img src="'.$image[0].'" class="cq-hovercard-background" />';
              }
        ...
        add_shortcode('cq_vc_hovercard', 'cq_vc_hovercard_func');
