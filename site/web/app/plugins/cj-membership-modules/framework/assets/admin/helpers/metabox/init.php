...
require_once('extensions/info.php');
require_once('extensions/multiselect.php');
require_once('extensions/lnglat.php');
require_once('extensions/address-by-zipcode.php');
require_once('extensions/working_hours.php');
require_once('extensions/screenshots.php');
require_once('extensions/background_properties.php');
require_once('extensions/padding_margin.php');
require_once('extensions/border.php');
