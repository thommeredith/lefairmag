...
<div class="ta-footer-promotion">
  <p><?php echo esc_html( $title ); ?>

  <ul class="ta-footer-promotion-links">
  ...
  <ul class="ta-footer-promotion-social">
  <li>
			<a href="https://www.facebook.com/thirstyaffiliates/" target="_blank" rel="noopener noreferrer">
		...
		<li>
			<a href="https://www.instagram.com/thirstyaffiliates/" target="_blank" rel="noopener noreferrer">
				<svg width="16" height="16" aria-hidden="true">
		...
		<li>
			<a href="https://www.linkedin.com/showcase/thirstyaffiliates/" target="_blank" rel="noopener noreferrer">
				<svg width="16" height="16" aria-hidden="true">
		...
		<li>
			<a href="https://twitter.com/thirstyaff/" target="_blank" rel="noopener noreferrer">
		...
		<li>
			<a href="https://www.youtube.com/channel/UCW3wEz5RJzVVVD9oIFTWD_Q" target="_blank" rel="noopener noreferrer">
				<svg width="17" height="16" aria-hidden="true">
