	...
	<div class="essb_welcome-tab changelog">
		<div class="feature-section col">
			<div>
				...
				<h3>Focus on visual & performance</h3>

				<p>We made various changes in plugin to make work faster than before. Now you can use the precompiled resources and cached counters which significant improves page load.</p>
				<p>We also focus on visual part. The new version 3.3 comes with 5 new templates added and new counter position Top</p>
				<p>We do not forget the mobile sharing too - we welcome Telegram as share network in the new version</p>
			</div>
		</div>
		...
		<div class="essb_welcome-feature feature-section col three-col">
			<div>
				...
				<h4>Precompiled resources</h4>

				<p>New version of Easy Social Share Buttons for WordPress includes new precompiled function which allows to bundle all static and dynamic styles into single file to improve page load.</p>
			</div>
			<div>
				<img class="essb-img-center" title=""
					src="<?php echo ESSB3_PLUGIN_URL ?>/assets/images/welcome/welcome-features-02.png" />
				<h4>Background cached counters</h4>

				<p>We also think for counters. Now you have option to use background cached counters. Those counters are updated on selected time and appear immediately on page</p>
			</div>
			<div class="last-feature">
				<img class="essb-img-center" title=""
					src="<?php echo ESSB3_PLUGIN_URL ?>/assets/images/welcome/welcome-features-03.png" />
				<h4>Share counter recovery</h4>

				<p>We know how important is to keep your social proof. Easy Social Share Buttons 3.3 comes with the most advanced social share recovery module that allows you to recover shares from various url changes, protocol change, domain change or with manual url enter.</p>
			</div>
		</div>
