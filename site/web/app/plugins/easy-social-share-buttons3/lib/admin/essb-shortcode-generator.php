...
jQuery(document).ready(function(){
	...
	private function includeOptionsForEasyMultiFans() {
		...
		$this->register("cover", array("type" => "checkbox", "text" => "Display cover above fans counter", "comment" => "Activate this option to display cover box above fans counter", "value" => "1"));
