...
ESSBOptionsStructureHelper::field_select('social', 'sharing-12', 'css_animations', __('Activate animations', ESSB3_TEXT_DOMAIN), __('Animations
									...
									templates.', ESSB3_TEXT_DOMAIN), array ("no" => "", "smooth" => "Smooth colors", "pop" => "Pop up", "zoom" => "Zoom out", "flip" => "Flip", "pop-right" => "Pop right", "pop-left" => "Pop left", "pop-both" => "Pop horizontal" ));
...
ESSBOptionsStructureHelper::field_heading('social', 'sharing-14', 'heading2', __('Button Counters', ESSB3_TEXT_DOMAIN));
...
ESSBOptionsStructureHelper::field_select('social', 'sharing-14', 'twitter_counters', __('Twitter share counter', ESSB3_TEXT_DOMAIN), __('Twitter announced new design of their buttons and shuting down counter endpoints. More information is provided in this article <a href="https://twittercommunity.com/t/a-new-design-for-tweet-and-follow-buttons/52791" target="_blank">https://twittercommunity.com/t/a-new-design-for-tweet-and-follow-buttons/52791</a>'.$counter_redirect, ESSB3_TEXT_DOMAIN), $listOfOptions);
...
ESSBOptionsStructureHelper::field_heading('social', 'sharing-14', 'heading2', __('Total Counter', ESSB3_TEXT_DOMAIN));
...
ESSBOptionsStructureHelper::field_heading('social', 'sharing-14', 'heading2', __('Avoid Social Negative Proof', ESSB3_TEXT_DOMAIN));
...
ESSBOptionsStructureHelper::field_heading('social', 'sharing-15', 'heading2', __('Cached share counters', ESSB3_TEXT_DOMAIN));
ESSBOptionsStructureHelper::field_select('social', 'sharing-15', 'cache_counter_refresh', __('Cached counters refresh interval', ESSB3_TEXT_DOMAIN), __('Choose interval of counter update when you use cached counters', ESSB3_TEXT_DOMAIN), $counter_refresh_time);

ESSBOptionsStructureHelper::field_heading('social', 'sharing-15', 'heading2', __('Real time share counters', ESSB3_TEXT_DOMAIN));
...
$listOfOptions = array("top" => "Top social posts (require build in analytics to be active)", "fans" => "Fans counter (require fans counter to be activated)", "html" => "Custom HTML message");
...
ESSBOptionsStructureHelper::field_textbox_stretched('display', 'positions-13', 'heroshare_second_fans', __('Fans counter shortcode', ESSB3_TEXT_DOMAIN), __('Fill in this field you fans counter shortcode that will be used if you select in second widget area to have fans counter. Shortcode can be generated using shortcode generator.', ESSB3_TEXT_DOMAIN));
...
function essb3_register_positions_by_posttypes() {
	global $wp_post_types, $essb_avaliable_content_positions, $essb_available_button_positions;
