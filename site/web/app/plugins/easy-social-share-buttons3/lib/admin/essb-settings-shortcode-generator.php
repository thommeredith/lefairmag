...
?>
		...
		<div class="essb-shortcode-container essb-shortcode-select">
			...
			if (defined('ESSB3_SFCE_VERSION')) {
				?>
				<a href="<?php echo esc_url(add_query_arg ( 'code', 'easy-multifans', 'admin.php?page=essb_redirect_shortcode&tab=shortcode' ));?>" class="essb-shortcode essb-shortcode-fixed">[easy-multifans]<br/><span class="essb-shortcode-comment">Display fans counter with extended options</span></a>
				<?php 
			}
