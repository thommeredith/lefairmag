...
<h3>Easy Social Share Buttons for WordPress</h3>
		...
		<p>Promote Easy Social Share Buttons for WordPress and earn money. <a href="<?php echo admin_url ("admin.php?page=essb_about&tab=essb-promote"); ?>"><b>Click here</b></a> to learn more.</p>
	</div>
	<div class="essb-quick-nav" id="essb-quick-nav">
		<ul>
			<li><a href="<?php echo admin_url ("admin.php?page=essb_redirect_quick&tab=quick");?>"><i
					class="fa fa-bolt fa-lg"></i><span>Quick Setup Wizard</span></a></li>
			<li><a href="admin.php?page=essb_options&tab=social&section=sharing&subsection=sharing-11"><i
					class="fa fa-eyedropper fa-lg"></i><span>Change template</span></a></li>
			<li><a href="admin.php?page=essb_options&tab=social&section=sharing&subsection=sharing-2"><i
					class="fa fa-share-alt fa-lg"></i><span>Share Buttons</span></a></li>
			<li><a href="admin.php?page=essb_options&tab=social&section=sharing&subsection=sharing-12"><i
					class="fa fa-square fa-lg"></i><span>Button style</span></a></li>
			<li><a href="admin.php?page=essb_options&tab=social&section=sharing&subsection=sharing-14"><i
					class="fa fa-spinner fa-lg"></i><span>Counters</span></a></li>
			<li><a href="admin.php?page=essb_redirect_display&tab=display&section=settings&subsection=settings-1"><i
					class="fa fa-image fa-lg"></i><span>Where to display</span></a></li>
			<li><a href="admin.php?page=essb_redirect_display&tab=display&section=positions&subsection=positions-1"><i
					class="fa fa-th-large fa-lg"></i><span>Button positions</span></a></li>
			<li><a href="admin.php?page=essb_redirect_display&tab=display&section=mobile&subsection=mobile-1"><i
					class="fa fa-mobile fa-lg"></i><span>Mobile Display</span></a></li>
			<li><a href="admin.php?page=essb_redirect_advanced&tab=advanced&section=optimization&subsection"><i
