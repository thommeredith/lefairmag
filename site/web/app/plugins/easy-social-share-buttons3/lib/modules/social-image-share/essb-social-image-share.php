...
class ESSBSocialImageShare {
	...
	function enqueue_scripts() {
		...
		//wp_enqueue_style ( 'essb-social-image-share', ESSB3_PLUGIN_URL . '/lib/modules/social-image-share/assets/css/easy-social-image-share2.css' );
		$resource_builder = ESSBResourceBuilder::get_instance();
		
		$resource_builder->add_static_resource_footer(ESSB3_PLUGIN_URL . '/lib/modules/social-image-share/assets/css/easy-social-image-share2.css', 'essb-social-image-share', 'css');
		wp_enqueue_script ( 'jquery' );
		wp_enqueue_script ( 'essb-social-image-share', ESSB3_PLUGIN_URL . '/lib/modules/social-image-share/assets/js/easy-social-image-share2.js', array ('jquery' ), false, true );
	}
