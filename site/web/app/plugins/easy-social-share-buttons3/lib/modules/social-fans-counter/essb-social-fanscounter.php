...
class ESSBSocialFansCounter {
	...
	public function register_plugin_shortcode_totalfans($attrs) {
		return ESSBSocialFansCounterUtils::total_fans();
	}
	...
	public function register_front_assets () {
		...
		$resource_builder->add_static_resource(ESSB3_PLUGIN_URL . '/lib/modules/social-fans-counter/assets/css/essb-social-fanscounter.css', 'essb-social-fanscounter', 'css');
