...
class ESSBSocialFansCounterUtils {
	...
	public static function social_url($social) {
		...
		switch ($social) {
			case 'facebook' :
				return 'https://www.facebook.com/' . ESSBSocialFansCounterHelper::get_option ( $social . '.id' );
				break;
			case 'twitter' :
				return 'https://www.twitter.com/' . ESSBSocialFansCounterHelper::get_option ( $social . '.id' );
				break;
			case 'google' :
				return 'https://plus.google.com/' . ESSBSocialFansCounterHelper::get_option ( $social . '.id' );
				break;
			case 'pinterest' :
				return 'https://www.pinterest.com/' . ESSBSocialFansCounterHelper::get_option ( $social . '.id' );
				break;
			case 'linkedin' :
			...
			case 'instgram' :
				...
				break;
			case 'youtube' :
				return 'https://www.youtube.com/' . ESSBSocialFansCounterHelper::get_option ( $social . '.account_type' ) . '/' . ESSBSocialFansCounterHelper::get_option ( $social . '.id' );
				break;
			case 'envato' :
				$ref = '';
