...
<article <?php post_class($post_class); ?>>
    ...
    <div class="post-content ll">

        <h2 class="entry-title"><?php the_title(); ?></h2>
        <?php porto_render_rich_snippets( false ); ?>
        <div class="post-meta">
            <?php if (in_array('author', $porto_settings['post-metas'])) : ?><span><i class="fa fa-file-text-o"></i> <?php echo __('Written by', 'porto'); ?> <?php the_author_posts_link(); ?></span><?php endif; ?>
	
		<span><?php echo __('on', 'porto'); ?> <?php porto_post_date(); ?></span>
            <?php
            $cats_list = get_the_category_list(', ');
            if ($cats_list && in_array('cats', $porto_settings['post-metas'])) : ?>
                <span>under <?php echo $cats_list ?></span>
            <?php endif; ?>
            <?php
