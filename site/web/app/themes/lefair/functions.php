...
// add image sizes
        add_image_size( 'blog-large', 990, 330,false );
...
//wp_enqueue_script( 'isInViewport', get_bloginfo( 'stylesheet_directory' ) . '/js/isInViewport/lib/isInViewport.js', array( 'jquery' ), 1000 );
//wp_enqueue_script( 'playOnlyInViewport', get_bloginfo( 'stylesheet_directory' ) . '/js/isInViewport/videoInViewport.js', array( 'jquery' ), 1000 );

wp_enqueue_script( 'mediaelement-and-player.min', get_bloginfo( 'stylesheet_directory' ) . '/js/mediaelement-and-player.min.js', array( 'jquery' ), 1000 );
wp_enqueue_script( 'mep-feature-playlist', get_bloginfo( 'stylesheet_directory' ) . '/js/mep-feature-playlist.js', array( 'jquery' ), 1000 );
wp_enqueue_script( 'web_load', get_bloginfo( 'stylesheet_directory' ) . '/js/web_load.js', array( 'jquery' ), 1000 );
wp_enqueue_style( 'progression-player', get_bloginfo( 'stylesheet_directory' ) . '/css/progression-player.css' );
...
// disabling default image compression
...
jQuery(document).ready(function ($) {
    ...
    $(window).scroll(function() {
        $("video").each(function(){
            if ($(this).is(":in-viewport").css( "background-color", "blue" ).text( "in viewport" );) {
                $(this)[0].play();
            } else {
                $(this)[0].pause();
            }
