...
if ($slideshow_type != 'none') : ?>
                ...
                if ($attachment) {
                    ...
                    <div>
                        <div class="img-thumbnail">
                            <div class="inner">
                                <img class="owl-lazy img-responsive" width="<?php echo $attachment['width'] ?>" height="<?php echo $attachment['height'] ?>" data-src="<?php echo $attachment['src'] ?>" alt="<?php echo $attachment['alt'] ?>"<?php if ($porto_settings['post-zoom']) : ?> data-image="<?php echo $attachment['src'] ?>" data-caption="<?php echo $attachment['caption']; ?>"<?php endif; ?> />
    ...
    if ($slideshow_type == 'video') {
        ...
        if ($video_code) {
            ...
            <div class="post-image single nn">
