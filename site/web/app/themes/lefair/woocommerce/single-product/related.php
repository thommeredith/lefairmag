...
if ( $products->have_posts() ) : ?>
	...
	<div class="related products">
	     ...
	     <h3 id="fancy-title-12" class="mk-fancy-title responsive-align-center avantgarde-title center-align "><span class="fancy-title-span pointed">Featured</span></h3>
         <h1 class="main-font" style="text-align: center;">PRODUCTS</h1>
