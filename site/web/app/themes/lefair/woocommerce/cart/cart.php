...
do_action( 'woocommerce_before_cart' ); ?>
 ...
 <h3 id="fancy-title-12" class="mk-fancy-title responsive-align-center avantgarde-title center-align "><span class="fancy-title-span pointed">Cart</span></h3>
         <h1 class="main-font" style="text-align: center;">SHOPPING</h1>
...
<div class="cart-collaterals col-sm-4 checkout-order-review">
