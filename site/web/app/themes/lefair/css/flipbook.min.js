...
! function(t, e, o, s) {
    t.fn.flipBook = function(t) {
        ...
        var p = o.createElement("div").style,
            c = function() {
                for (var t, e = "t,webkitT,MozT,msT,OT".split(","), i = 0, o = e.length; o > i; i++)
                    if (t = e[i] + "ransform", t in p) return e[i].substr(0, e[i].length - 1);
                return !1
            }(),
            d = function(t) {
            ...
            if (0 != this.bookLayer.height()) {
                ...
                w.fillStyle = "#FFFFFF", t.getTextContent().then(function(s) {
                    ...
                    n.options.pages[e].renderTask = t.render(r).then(function() {
                        if (n.options.pages[e].renderedPage = t, w.fillRect(0, 0, d.width, d.height), w.imageSmoothingEnabled = !1, w.drawImage(d, 0, 0, m, b), "doubleWithCover" == n.options.pageMode)
                            if (0 == e) n.options.pages[0].canvas = v;
                            else if (e == n.options.pages.length / 2) n.options.pages[n.options.pages.length - 1].canvas = v;
                        else {
        ...
        createBook: function() {
            ...
            if (t.options.pages.length > 0)
                for (var o = 0; o < t.options.pages.length; o++) "undefined" != typeof t.options.pages[o].htmlContent && (t.options.viewMode = "3d");
            if ("webgl" == t.options.viewMode) {
                var a = t.options;
        ...
        pdfResize: function() {
            ...
            this.pdfDocument.getPage(1).then(function(e) {
                ...
                var o = e.getViewport(1),
                    s = t.bookLayer.height();
    ...
    if (!this.flipping) {
        ...
        var s = 1e3,
            n = this.options.pageFlipDuration * s;
        n *= Math.abs(end - this.angle) / 180, this.options.singlePageMode && (n /= 2), jQuery({
            someValue: o.angle
        }).animate({
            someValue: end
        }, {
...
var CustomStyle = function() {
        ...
        return t.getProp = function(t, o) {
            ...
            for (var a = 0, h = e.length; h > a; a++)
                if (s = e[a] + n, "string" == typeof r[s]) return i[t] = s;
        ...
        return t.prototype = {
            ...
            renderLayer: function() {
                ...
                for (var n, r, a = 0; i > a; a++) {
                    ...
                    if (void 0 === h.dataset.isWhitespace) {
                        var l = h.style.fontSize,
                            p = h.style.fontFamily;
            ...
            render: function(t) {
                if (this.divContentDone && !this.renderingDone)
                    if (this.renderTimer && (clearTimeout(this.renderTimer), this.renderTimer = null), t) {
                        var e = this;
            ...
            appendText: function(t, e) {
                ...
                var s = PDFJS.Util.transform(this.viewport.transform, t.transform),
                    n = Math.atan2(s[1], s[0]);
                i.vertical && (n += Math.PI / 2);
                var r = Math.sqrt(s[2] * s[2] + s[3] * s[3]),
                    a = r;
                ...
                if (0 !== t.length) {
                    ...
                    for (var u = c; d > u; u++) {
                        var g = t[u],
                            ...
                            b = a && u === h,
                            v = b ? " selected" : "";
                        if (this.findController && this.findController.updateMatchPosition(r, u, s, f.divIdx, m.divIdx), n && f.divIdx === n.divIdx ? i(n.divIdx, n.offset, f.offset) : (null !== n && i(n.divIdx, n.offset, p.offset), e(f)), f.divIdx === m.divIdx) i(f.divIdx, f.offset, m.offset, "highlight" + v);
                        else {
