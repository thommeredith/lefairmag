            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'desc' => '<br/><strong style="color:#ff0000">'.__('Please click each process only once.', 'porto') . '</strong><br/><strong>'.__('If import failed, please check your site and click again "Import" button.', 'porto') . '</strong>',
                        'style' => 'success'
                    ),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        'id'=>'mobile-panel-pos',
                        'type' => 'button_set',
                        'title' => __('Moobile Panel Position', 'porto'),
                        'options' => array(
                            '' => __('Default', 'porto'),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'desc' => __('You should input comma separated block slug names. You can create a block in <strong>Blocks/Add New</strong>.', 'porto')
                    ),
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'options' => array(
                            ...
                            "timeline" => array('alt' => __('Timeline', 'porto'), 'img' => porto_options_uri.'/images/portfolio_archive_style_2.jpg'),
                            "full" => array('alt' => __('Full', 'porto'), 'img' => porto_options_uri.'/images/portfolio_archive_style_3.jpg'),
                            "large" => array('alt' => __('Large', 'porto'), 'img' => porto_options_uri.'/images/portfolio_archive_style_4.jpg'),
                            "medium" => array('alt' => __('Medium', 'porto'), 'img' => porto_options_uri.'/images/portfolio_archive_style_5.jpg'),
                        ),
                        'default' => 'grid'
                    ),
                    array(
                    ...
                    array(
                        ...
                        'options' => array(
                            ...
                            "full" => array('alt' => __('Full Width', 'porto'), 'img' => porto_options_uri.'/images/portfolio_archive_view_2.jpg'),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'title' => __('Portfolio Layout', 'porto'),
                        'options' => array(
                            "full" => array('alt' => __('Full', 'porto'), 'img' => porto_options_uri.'/images/portfolio_single_style_1.jpg'),
                            "large" => array('alt' => __('Large', 'porto'), 'img' => porto_options_uri.'/images/portfolio_single_style_2.jpg'),
                            "medium" => array('alt' => __('Medium', 'porto'), 'img' => porto_options_uri.'/images/portfolio_single_style_3.jpg'),
                        ),
                        'default' => 'medium'
                    ),
