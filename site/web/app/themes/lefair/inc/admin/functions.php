...
function porto_options_header_types() {
    return array(
        ...
        '17' => array('alt' => __('Header Type 17', 'porto'), 'img' => porto_options_uri.'/headers/header_17.jpg'),
...
function porto_demo_types() {
    return array(
        ...
        '_25' => array('alt' => __('Demo 25', 'porto'), 'img' => porto_options_uri.'/demos/demo_25.jpg'),
