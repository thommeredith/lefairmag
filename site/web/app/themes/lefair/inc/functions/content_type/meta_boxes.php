...
function porto_ct_default_meta_view_boxes() {
    ...
    return apply_filters('porto_meta_view_options', array(
        // Loading Overlay
        ...
        "content_bottom"=> array(
            ...
            "desc" => __("You should input comma separated block slug name. You can create a block in <strong>Blocks/Add New</strong>.", 'porto'),
            "type" => "text"
        )
    ));
}
...
function porto_ct_default_meta_skin_boxes() {
    ...
    return apply_filters('porto_meta_skin_options', array(
        // Body Background
        "body_bg_color"=> array(
            "name" => "body_bg_color",
