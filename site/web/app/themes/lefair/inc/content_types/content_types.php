...
// Create Meta Table
function porto_create_metadata_table($table_name, $type) {
    global $wpdb;

    if (get_option('porto_created_table_' . $table_name, false) === false) {
        ...
        update_option('porto_created_table_' . $table_name, true);
    }
}
