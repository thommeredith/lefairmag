...
<article <?php post_class($post_class); ?>>
    ...
    <div class="post-content w">

        <?php // Post Slideshow ?>
        <a href="<?php the_permalink()?>"><?php get_template_part('slideshow', 'large'); ?></a>
	...
	<div class="row">
	<a style="border:none !important;" class="btn btn-xs btn-primary pt-right read-btn" href="<?php echo esc_url( apply_filters( 'the_permalink', get_permalink() ) ) ?>"><?php _e('<img src="http://lefairtemp.com/wp-content/uploads/2016/06/continue-read-1.png" width="13"/> Read More...', 'porto') ?></a>
	</div><!-- row end here -->
	<div class="social-share-row row">
	<?php echo do_shortcode('[easy-social-share buttons="facebook,twitter,google,pinterest" counters=0 style="icon"]'); ?>  
	</div><!-- social-share-row row end here -->
