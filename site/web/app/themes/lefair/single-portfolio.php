            ...
            if ($porto_settings['portfolio-related']) :
                ...
                if ($related_portfolios->have_posts()) : ?>
                    <div class="related-portfolios <?php echo $porto_settings['portfolio-related-style'] ?>">
                        ...
                        <div class="row">
                            <div class="portfolio-carousel owl-carousel show-nav-title" data-cols-lg="<?php echo ($porto_layout == 'wide-left-sidebar' || $porto_layout == 'wide-right-sidebar' || $porto_layout == 'left-sidebar' || $porto_layout == 'right-sidebar') ? '3' : '4' ?>" data-cols-md="3" data-cols-sm="2">
                                <?php
