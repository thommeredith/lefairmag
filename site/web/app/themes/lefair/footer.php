...
<script type="text/javascript">
    ...
    ;(function ($, window, document, undefined) {
        jQuery(document).ready(function () {
            jQuery('.rs-background-video-layer').click(function(){
                jQuery(this).find(".tp-video-play-button").click();
            });
            jQuery('.web-slider-video video').click(function(){
                //webplaypause(jQuery(this));
